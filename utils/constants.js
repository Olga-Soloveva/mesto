...
export const formPersonName = document.querySelector('.popup_type_edit-profile #name-input');
export const formDescription = document.querySelector('.popup_type_edit-profile #description-input');
